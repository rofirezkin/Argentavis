        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid" id="hilang1">
              <h2 class="no-margin-bottom">Surat Masuk Report</h2>
            </div>
          </header>
          <section class="dashboard-counts no-padding-bottom">
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location:suratmasukreport.php");
                die();
            } else {

                if (!$result = mysql_query("SELECT * FROM tbl_surat_masuk WHERE tgl_surat BETWEEN '$dari_tanggal' AND '$sampai_tanggal'")) {
                    exit(mysql_error());
                  }
                ...
                <!-- Row form END -->
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            <div class="disp hidd">';
                                ...
                                echo '<h6 class="up" align="center"> Laporan Surat Masuk</h6>';
                    ...
                    <div id="colres" class="warna cetak table-responsive">
                        <table class="bordered table" id="tbl" width="100%">
