...
<html>
  ...
  <body>
    <div class="container">  
	  <form id="contact" action="proses_editsuratkeluar.php" method="post" enctype="multipart/form-data" checkall();>
	    ...
	    <fieldset id="10" style="display: none;">
	    	<span>Isi Ringkasan</span>
	      <input class="form-control" id="tisi" name="tisi" placeholder="Isi Ringkasan" type="text" required>
	    </fieldset>
		 ...
		 if(name)
		 {
		  ...
		  success: function (response) {
		   ...
		   else
		   {
		    ...
		    $.post("../admin/bacasuratkeluar.php", {
		            id: id
		        },
