...
<html>
  ...
  <body>
    <div class="container">  
	  <form id="contact" action="proses_tambahsuratkeluar.php" method="post" enctype="multipart/form-data" checkall();>
	    ...
	    <fieldset>
	      <input class="form-control" name="ttujuan" placeholder="Tujuan" type="text" required>
	    </fieldset>
	    <fieldset>
	      <input class="form-control" name="tisi" placeholder="Isi Ringkasan" type="text" required>
	    </fieldset>
	    <fieldset>
