...
<html>
  ...
  <body>
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="klasifikasi.php"><i class=""></i>Klasifikasi</a></li>
        ...
        <div class="content-inner">
          ...
          <section class="dashboard-counts no-padding-bottom">
            ...
            <div class="form-inline container-fluid">
              <div class="">
                  <a href="tambah_klasifikasi.php" data-toggle="tooltip" title="Tambah klasifikasi"><img src="../img/tambah.png"></a>&nbsp&nbsp&nbsp
                  <a href="ubah_klasifikasi.php" data-toggle="tooltip" title="Ubah klasifikasi"><img src="../img/ubah.png"></a>
              </div>
            </div>
          ...
          <section class="dashboard-counts no-padding-bottom">
            ...
            <?php
              ...
              $query = "SELECT * FROM tbl_klasifikasi order by id_klasifikasi asc";
              ...
              if(mysql_num_rows($result) > 0)
              {
                ...
                while($row = mysql_fetch_assoc($result))
                {
                  ...
                  <tr>
                    ...
                    <td>'.$row['uraian'].'</td>
                    <td>
                      <button onclick="deletedisposisi('.$row['id_klasifikasi'].')" data-toggle="tooltip" title="Hapus klasifikasi"><img src="../img/buang.png" height="35px" width="35px"></button>
                    </td>
                  </tr>
                  ';
                  $number++;
    ...
    <div class="modal fade" id="deletesiswa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <br>
          <center>
          <h5>Kamu Yakin, Ingin Delete klasifikasi Ini ?</h5>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Cancel</button>
            <button type="button" class="btn btn-danger" onclick="suratdelete()">Delete Klasifikasi</button>
    ...
    function suratdelete() {
        ...
        $.post("../admin/proses_deleteklasifikasi.php", {
                id: id
            },
            function (data, status) {
                // hide modal popup
