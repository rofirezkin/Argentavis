...
<html>
  ...
  <body>
    <div class="container">  
	  <form id="contact" action="proses_tambahklasifikasi.php" method="post" enctype="multipart/form-data" checkall();>
	    <h3>Tambah Surat Keluar</h3><br>
	    <fieldset>
	     ...
	     <input class="form-control" name="tnomersurat" placeholder="Kode" type="text" 
	      id="NoSurat" onkeyup="checkno();" style="text-transform:uppercase" required autofocus>
	    </fieldset>
	    <fieldset>
	      <input class="form-control" name="tkodesurat" placeholder="Nama" type="text" required>
	    </fieldset>
	    <fieldset>
	      <input class="form-control" name="ttujuan" placeholder="Uraian" type="text" required>
	    </fieldset><br>
	    <fieldset>
