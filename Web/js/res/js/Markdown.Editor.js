...
(function () {
    ...
    ui.prompt = function (title, text, defaultInputText, callback) {
        ...
        var createDialog = function () {
            ...
            mainDialog = doc.createElement("div");
            mainDialog.className = "modal-dialog modal-md";
            dialog.appendChild(mainDialog);

            content = doc.createElement("div");
            content.className = "modal-content";
            mainDialog.appendChild(content);
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            group1 = makeGroup(1);
            buttons.bold = makeButton("wmd-bold-button", "Cetak Tebal - Ctrl+B", "fa fa-bold", bindCommand("doBold"), group1);
            buttons.italic = makeButton("wmd-italic-button", "Cetak Miring - Ctrl+I", "fa fa-italic", bindCommand("doItalic"), group1);
            buttons.newline = makeButton("wmd-newline-button", "Garis Baru", "fa fa-level-down", bindCommand("doNewLine"), group1);
            
            group2 = makeGroup(2);
            buttons.link = makeButton("wmd-link-button", "Tautan - Ctrl+L", "fa fa-link", bindCommand(function (chunk, postProcessing) {
                return this.doLinkOrImage(chunk, postProcessing, false);
            }), group2);
            buttons.quote = makeButton("wmd-quote-button", "Kutipan - Ctrl+Q", "fa fa-quote-left", bindCommand("doBlockquote"), group2);
            buttons.code = makeButton("wmd-code-button", "Kode Sampel - Ctrl+K", "fa fa-code", bindCommand("doCode"), group2);
            buttons.image = makeButton("wmd-image-button", "Gambar - Ctrl+G", "fa fa-picture-o", bindCommand(function (chunk, postProcessing) {
                return this.doLinkOrImage(chunk, postProcessing, true);
            }), group2);

            group3 = makeGroup(3);
            buttons.olist = makeButton("wmd-olist-button", "Urutan Bernomor - Ctrl+O", "fa fa-list-ol", bindCommand(function (chunk, postProcessing) {
                this.doList(chunk, postProcessing, true);
            }), group3);
            buttons.ulist = makeButton("wmd-ulist-button", "Urutan - Ctrl+U", "fa fa-list-ul", bindCommand(function (chunk, postProcessing) {
                this.doList(chunk, postProcessing, false);
            }), group3);
            buttons.heading = makeButton("wmd-heading-button", "Judul - Ctrl+H", "fa fa-header", bindCommand("doHeading"), group3);
            buttons.hr = makeButton("wmd-hr-button", "Garis Horizontal - Ctrl+R", "fa fa-ellipsis-h", bindCommand("doHorizontalRule"), group3);
            
            group4 = makeGroup(4);
            buttons.undo = makeButton("wmd-undo-button", "Undo - Ctrl+Z", "fa fa-rotate-left", null, group4);
    ...
    commandProto.doNewLine = function (chunk, postProcessing) {
        chunk.startTag = "<br>\n";
        chunk.selection = "";
    }
